...
| -------|------------| ---------------------- |---------------------- |
| Solubility | [ESOL](https://moleculenet.org/datasets-1})| Contains chemical structures along with their corresponding experimentally determined solubility values in water|Descriptors, ECFP-14|[Paper](https://academic.oup.com/bib/article/23/1/bbab367/6366324)|
